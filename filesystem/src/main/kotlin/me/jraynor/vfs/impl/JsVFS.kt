 ...
 */
class JsVFS(workspacePath: VPath) : BaseVFS(workspacePath) {

    private object InternalJsAccessor : FileAccessor {
        /**
     ...
     */
    override fun fileAccessor(): FileAccessor = InternalJsAccessor
